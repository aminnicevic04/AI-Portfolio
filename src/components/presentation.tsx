...
export function Presentation() {
  ...
  const profile = {
    ...
    description:
      "Hey 👋\nI'm Amin, a software engineering student and developer. I'm passionate about building beautiful and functional web applications, especially with technologies like React and Next.js. When I'm not coding, you can usually find me exploring nature or planning my next adventure.",
    src: '/amin.png', 
    fallbackSrc:
    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          >
            {['Developer', 'React', 'Next.js', 'Front-End Developer', 'SaaS Builder'].map(
              (tag) => (
                <span
                  key={tag}
